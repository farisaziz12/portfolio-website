      ...
      >
        ...
        <div className="p-6 flex-grow">
          ...
          <div className="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-2">
            ...
            <span className="text-lg">{getCountryFlag(event.location)}</span>
          </div>
        ...
        <div className="px-6 pb-6 mt-auto">
          {/* "More Event Details" button that opens the modal */}
          <button
            onClick={() => setIsModalOpen(true)}
            className="text-blue-600 font-medium inline-flex items-center hover:text-blue-700 focus:outline-none"
          >
            More Event Details
          ...
          {/* Show the old links for past events */}
          {!isUpcoming && (
