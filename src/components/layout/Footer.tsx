...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-gray-800 py-10 mt-20">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300 max-w-md">
              Engineering Manager & Frontend SME | Conference Speaker | 
              Frontend Expert in NextJS, TS/JS & NodeJS | Pioneering a Tech Culture of Innovation
            </p>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-10 pt-6 text-center text-gray-600 dark:text-gray-300 text-sm">
          <p>© {currentYear} Faris Aziz. All rights reserved.</p>
          <p className="mt-2">
