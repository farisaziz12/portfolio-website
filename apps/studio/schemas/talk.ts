...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'boolean',
      description: 'Show this talk as the "Most-watched" featured talk on the homepage. Only one talk should be marked.',
      initialValue: false,
      group: 'content',
    }),
    defineField({
      name: 'viewCount',
      title: 'View count (approx.)',
      type: 'number',
      description: 'Optional. Shown on the homepage featured talk (e.g. 18000 → "18k views").',
      group: 'content',
    }),
    defineField({
      name: 'assets',
      ...
      fields: [
        ...
        { name: 'videoUrl', title: 'Video URL (YouTube)', type: 'url' },
