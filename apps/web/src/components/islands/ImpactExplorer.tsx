...
export default function ImpactExplorer({
  ...
  // Handle lens toggle
  const handleLensChange = useCallback((newLens: ImpactLens) => {
    setLens(newLens);
  }, []);
    ...
    <div className="impact-explorer">
      ...
      <div className="mb-8 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          {/* Lens Toggle */}
          <div
            className="inline-flex rounded-lg bg-surface-overlay border border-edge p-1"
            role="radiogroup"
            aria-label="Select view lens"
          >
            {LENS_CONFIG.map((l) => (
              <button
                key={l.id}
                ...
                className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 ${
                  lens === l.id
    ...
    >
      ...
      >
        <div className="px-4 pb-4 border-t border-edge pt-4 space-y-4">
          {/* Card-level Lens Toggle */}
          <div
            className="inline-flex rounded-lg bg-surface-overlay border border-edge p-0.5"
            role="radiogroup"
          ...
          >
            {LENS_CONFIG.map((l) => (
              <button
                ...
                className={`px-2.5 py-1 rounded-md text-xs font-medium transition-all focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 ${
                  localLens === l.id
